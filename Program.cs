    ...
    class Program
    {
        ...
        static void dos_start() {
            ...
            while (blivVedogved) {
                ...
                // FEJL 1: Switchen handler ud fra variablen valg. string valg1 er unødvendig og har det forkerte navn.
                // Jeg fiksede det ved at converte vores input til en int32 så switchen kan forstå hvad den skal.
        ...
        */
        ...
        static void dos_udskrivKonto(Konto k) {         
            ...
            Console.WriteLine("\n\n {0,-30} {1,10} {2,10}", "Tekst", "Beløb", "Saldo");
            foreach (Transaktion t in k.transaktioner) {
                Console.WriteLine("\n\n {0,-30} {1,10} {2,10}", t.tekst, t.amount, t.saldo );

                // FEJL 2: Det var ikke til at se hvad der hørte til hvad så jeg formaterede udskriften
        ...
        public static bool GemTrans(Konto konto, string tekst, float amount) {
            ...
            // FEJL 3: en statisk variabel ved navn beløb der gjorde at amount altid var 0, jeg fjernede variablen og sørgede for
            // at metoden referere til den rigtige variabel som er amount.
